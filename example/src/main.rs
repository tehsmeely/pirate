...
mod rpcs {
    ...
    // TODO: One day this will likely be generated by a proc macro!
    impl RpcDefinition<RpcId, ServerState, String, ()> for AddName {
        fn client() -> Rpc<RpcId, String, ()> {
            Rpc::new(Self::name())
        }

        fn server() -> RpcImpl<RpcId, ServerState, String, ()> {
    ...
    // TODO: One day this will likely be generated by a proc macro!
    impl RpcDefinition<RpcId, ServerState, (), Vec<String>> for GetNames {
        fn client() -> Rpc<RpcId, (), Vec<String>> {
            Rpc::new(Self::name())
        }

        fn server() -> RpcImpl<RpcId, ServerState, (), Vec<String>> {
            RpcImpl::new(Self::name(), Box::new(Self::implement))
        }
    }
}
